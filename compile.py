...
"""
Utility script that compresses gitignore files into the production script
"""
__version__ = "1.0"
...
SCRIPT = 'generate-gitignore.py'
# SCRIPT = 'tmp'
DICT_NAME = 'GIT_DEFS'
SCRIPT_SECTION = 'GITIGNORE DEFS'
...
def main():
    ...
    try:
        ...
        for filename in glob.glob("gitignore/*.gitignore"):
            (name, ext) = os.path.splitext(os.path.basename(filename))
            name = name.lower()
            gi_file = open(filename, 'r')
            contents = gi_file.read()
